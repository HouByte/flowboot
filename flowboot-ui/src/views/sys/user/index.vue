<template>
  <div>
    <el-form :inline="true">
      ...
      <el-form-item>
        <el-button type="primary" @click="dialogVisible = true" v-hasPermi="['sys:user:add']" >新增</el-button>
      </el-form-item>
      <el-form-item>
  ...
  methods: {
    ...
    submitForm(formName) {
      this.$refs[formName].validate((valid) => {
        if (valid) {
          saveUser(this.editForm.id?'update' : 'save', this.editForm)
              .then(res => {
